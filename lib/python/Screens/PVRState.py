...
class PTSTimeshiftState(Screen):
	skin = """
		<screen position="center,40" zPosition="2" size="420,70" backgroundColor="transpBlack" flags="wfNoBorder">
			...
			<widget name="statusicon" position="12,45" size="20,20" zPosition="5" alphatest="on" pixmaps="Nobile.HDF.Mod/icons/play.png,Nobile.HDF.Mod/icons/pause.png,Nobile.HDF.Mod/icons/stop.png,Nobile.HDF.Mod/icons/forward.png,Nobile.HDF.Mod/icons/backward.png,Nobile.HDF.Mod/icons/slow.png" />
