...
wget http://addons.hdfreaks.cc/et9000/driver/driver_et9x00_01022012.tar.gz
echo "make backup"
...
tar xzvf /tmp/driver_et9x00_01022012.tar.gz 2> /dev/null
rm -f /tmp/driver_et9x00_01022012.tar.gz
echo
