...
imagesCounter = 0
images.append(["switch to V6.4", "http://images.hdfreaks.cc"])
images.append(["switch to V6.3", "http://v64.hdfreaks.cc"])
images.append(["switch to V6.2", "http://v63.hdfreaks.cc"])
...
images.append(["switch to V6.3", "http://teamimages.hdfreaks.cc"])
...
class FlashOnline(Screen):
	...
	def list_files(self, PATH):
		...
		if SystemInfo["HaveMultiBoot"]:
			path = PATH
			if getMachineBuild() in ("hd51","vs1500","h7","8100s","gb7252","cc1","sf8008","sf8008s","sf8008t","osmio4k"):
	...
	def Start_Flashing(self):
		...
		if os.path.exists(ofgwritePath):
			...
			if self.simulate:
				...
				elif getMachineBuild() in ("u51","u52","u53","u5","u5pvr","cc1","sf8008","sf8008s","sf8008t","hd60","hd61","v8plus"):
