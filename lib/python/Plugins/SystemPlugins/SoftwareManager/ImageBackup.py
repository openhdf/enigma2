...
class ImageBackup(Screen):
	...
	<screen position="center,center" size="560,400" title="Image Backup">
		...
		<widget name="info-hdd" position="10,20" zPosition="1" size="550,100" font="Regular;20" halign="left" valign="top" transparent="1" />
		<widget name="info-usb" position="10,120" zPosition="1" size="550,200" font="Regular;20" halign="left" valign="top" transparent="1" />
	...
	def __init__(self, session, args = 0):
		...
		self["info-yellow"] = Label(_("Press Yellow Button to switch between TV/Backup \nduring the backup is running."))
	...
	def doFullBackup(self, DIRECTORY):
		...
		if self.MODEL == "et9000" or self.MODEL == "et5000" or self.MODEL == "et6000" or self.MODEL == "et6500" or self.MODEL == "et4000":
			self.TYPE = "ET"
