...
class VideoHardware:
	...
	def __init__(self):
		...
		if getBoxType() == 'gbquad' or getBoxType().startswith('odin') or getBoxType() == 'et5x00' or getBoxType() == 'ixussone' or getBoxType() == 'ixusszero' or model == 'et6000' or getBoxType() == 'e3hd' or getBoxType() == 'ebox7358' or getBoxType() == 'ebox5100' or getBoxType() == 'tmnano' or getBoxType() == 'odimm7' or getBoxType() == 'odimm6' or self.hw_type == 'ultra' or self.hw_type == "me" or self.hw_type == "minime":
