...
class ScSelection(Screen):
    ...
    def __init__(self, session):
        ...
        self['actions'] = ActionMap(['OkCancelActions', 'ColorActions', 'CiSelectionActions'], {'left': self.keyLeft, 'right': self.keyRight, 'cancel': self.cancel, 'ok': self.ok, 'green': self.save, 'red': self.cancel, 'blue': self.blue}, -1)
        self.list = []
