...
def getCPUString():
	if getMachineBuild() in ('vuuno4k', 'vuultimo4k','vusolo4k', 'hd51', 'hd52', 'sf4008', 'dm900', 'dm920', 'gb7252', 'dags7252', 'vs1500', 'h7', '8100s','osmio4k','osmio4kplus'):
		return "Broadcom "
...
def getCPUSpeedString():
	if getMachineBuild() in ('vusolo4k'):
		...
		return "1,3 GHz"
	elif getMachineBuild() in ('hd51','hd52','sf4008','vs1500','et1x000','h7','8100s','osmio4k','osmio4kplus'):
		try:
			import binascii
