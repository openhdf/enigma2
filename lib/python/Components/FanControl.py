...
class FanControl:
	...
	def __init__(self):
		if os_path.exists("/proc/stb/fp/fan_vlt") or os_path.exists("/proc/stb/fp/fan_pwm") or os_path.exists("/proc/stb/fp/fan_speed"):
			self.fancount = 1
		else:
			self.fancount = 0
		self.createConfig()
	...
	def hasRPMSensor(self, fanid):
		return os_path.exists("/proc/stb/fp/fan_speed")

	def hasFanControl(self, fanid):
		return os_path.exists("/proc/stb/fp/fan_vlt") or os_path.exists("/proc/stb/fp/fan_pwm")
