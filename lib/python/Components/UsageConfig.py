...
def InitUsageConfig():
	...
	config.misc.useNTPminutes = ConfigSelection(default="30", choices=[("30", "30" + " " + _("minutes")), ("5", "5" + " " + _("minutes")), ("15", "15" + " " + _("minutes")), ("60", _("Hourly")), ("1440", _("Once per day"))])
	...
	config.usage.numzaptimeout1 = ConfigSelectionNumber(default=2000, stepwidth=250, min=250, max=10000, wraparound=True)
...
#####################################################
	...
	config.misc.softcam_streamrelay_delay = ConfigSelectionNumber(min=0, max=3000, stepwidth=50, default=400, wraparound=True)
